...
function peg$parse(input, options) {
  ...
  var peg$f3 = function(varName, value) {return 'let ' + varName.val + ' = ' + value  };
  var peg$f4 = function(contextName, words) { 
  ...
  var peg$f5 = function(contextName, functionName, params) { 
    if (contextName) {
  ...
  var peg$f6 = function(word) { return {type:'word', val:word.join('')}; };
  var peg$f7 = function(word) { return {type:'word', val:word.join('')}; };
  var peg$f8 = function(param) { return {type:'param', val:param.join('')}; };
  var peg$f9 = function(whitespace) {
    return '';
  };
  ...
  function peg$parsemain() {
    ...
    s3 = [];
    s4 = peg$parseassignVar();
    if (s4 === peg$FAILED) {
      s4 = peg$parsedefinePrompt();
      if (s4 === peg$FAILED) {
  ...
  function peg$parsedefinePrompt() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11;
